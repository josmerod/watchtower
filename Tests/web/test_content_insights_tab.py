...
with patch("src.web.dashboard.components.recommendations_tab.recommendations_manager") as mock_rec_mgr, patch("src.web.dashboard.trend_utils.load_latest_trends") as mock_load_trends:
    from src.web.dashboard.components.intelligence_tab import create_recommendations_section, create_trending_section, render_intelligence_tab
...
class TestContentInsightsTab:
    def test_render_intelligence_tab_structure(self):
        ...
        # Setup mocks
        with (
            patch("src.web.dashboard.components.intelligence_tab.create_recommendations_section") as mock_create_recs,
    ...
    def test_create_trending_section_with_data(self, mock_load_trends):
        ...
        mock_load_trends.return_value = [{"title": "Trend 1", "trend_score": 10.0}, {"title": "Trend 2", "trend_score": 5.0}]
