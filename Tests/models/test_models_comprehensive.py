...
class TestNewsModels(unittest.TestCase):
    ...
    def test_news_article_model_complete(self):
        ...
        metrics = NewsMetrics(read_time_minutes=5, social_shares=250, comments_count=42)
...
class TestEcommerceModels(unittest.TestCase):
    ...
    def test_product_model_complete(self):
        ...
        price = ProductPrice(current_price=99.99, original_price=149.99, currency="USD")

        metrics = ProductMetrics(sales_count=1500, rating_average=4.5, review_count=250)
