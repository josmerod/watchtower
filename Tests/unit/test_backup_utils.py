...
class TestBackupManager(unittest.TestCase):
    ...
    def test_upload_single_file(self):
        ...
        self.mock_google_drive_instance.ListFile.assert_called_once_with({"q": f"'{self.mock_settings.google_drive.backup_folder_id}' in parents and title='{drive_filename}' and trashed=false"})
