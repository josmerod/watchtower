...
from src.config.models import (
    DatabaseConfig, ETLConfig, LoggingConfig, StreamlitConfig, 
    SecurityConfig, APIConfig, WatcherConfig, ScrapingConfig,
    MonitoringConfig, NotificationConfig, GoogleDriveConfig
)
...
"""
    ...
    def test_settings_nested_config_access(self):
        ...
        self.assertEqual(settings.logging.format, "%(asctime)s - %(name)s - %(levelname)s - %(message)s")
