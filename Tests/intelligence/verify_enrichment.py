        ...
        return [
            {
                ...
                "content": "Python 3.13 introduces a JIT compiler and removes the GIL in free-threaded builds. This is a massive milestone for performance."
            }
        ]
...
def test_enrichment_flow():
    ...
    print(f"ETL finished. Succcess: {metrics.is_successful}")
    ...
    item = EnrichedNewsItem(
        ...
        content="Autonomous agents are becoming the dominant paradigm in AI development."
    )
