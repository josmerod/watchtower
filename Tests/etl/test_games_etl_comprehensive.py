...
class TestGamesETLComprehensive(unittest.TestCase):
    ...
    def test_deals_etl_data_quality(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            deal = data[0]
            required_fields = ['title', 'link', 'discount_percent', 'current_price', 'regular_price', 'store', 'drm']
    ...
    def test_bundles_etl_data_quality(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            required_fields = ['title', 'link', 'discount_percent', 'current_price', 'regular_price', 'store']
            for field in required_fields:
    ...
    def test_new_releases_etl_without_api_key(self):
        ...
        self.assertIn('id|name|released|platforms|genres|metacritic|description_raw|rawg_link', content)
    ...
    def test_new_releases_etl_with_api_key(self):
        ...
        with patch('src.etl.games.games_get_new_releases.API_KEY', 'test_api_key'):
            with patch('requests.get') as mock_get:
                ...
                required_fields = ['id', 'name', 'released', 'platforms', 'genres', 'metacritic', 'description_raw', 'rawg_link']
                for field in required_fields:
                    self.assertIn(field, game, f"Missing field: {field}")
...
class TestGamesDataQuality(unittest.TestCase):
    ...
    def test_deals_data_schema_validation(self):
        ...
        # Schema validation
        required_columns = ['title', 'link', 'discount_percent', 'current_price', 'regular_price', 'store', 'drm']
    ...
    def test_deals_data_consistency(self):
        ...
        for _, row in df.iterrows():
            if row['regular_price'] > 0:
                ...
                self.assertAlmostEqual(expected_discount, actual_discount, delta=5, 
    ...
    def test_empty_files_structure(self):
        ...
        empty_files = ['deals.json', 'bundles.json', 'giveaways.json', 'itchio_trending.json', 'new_releases.json']
