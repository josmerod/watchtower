...
try:
    ...
    print(
        "and that the 'src' directory is correctly structured with 'web/new_dashboard_poc/app.py'."
    )
...
if __name__ == "__main__":
    ...
    try:
        ...
        if "app" in locals() and app is not None:
            ...
            print(
                "Error: The Dash 'app' object was not loaded correctly. Cannot start server."
            )
            sys.exit(1)
