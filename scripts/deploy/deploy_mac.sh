...
echo "========================================================"
echo "  🏯 Watchtower Dashboard - macOS Deployment Script"
...
echo "[INFO] Starting Watchtower deployment on macOS..."
...
if ! command -v python3 &> /dev/null && ! command -v python &> /dev/null; then
    ...
    echo "[INFO] Install with Homebrew: brew install python"
    echo "[INFO] Or download from: https://python.org/downloads/"
    echo "[INFO] Or install Xcode Command Line Tools: xcode-select --install"
    exit 1
fi
...
echo "  - If you get permission errors, try: sudo xcode-select --install"
echo "  - For Homebrew users: brew install python uv"
echo "  - Some features may require Xcode Command Line Tools"
echo ""
