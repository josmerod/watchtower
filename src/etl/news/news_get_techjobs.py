...
def generate_mock_tech_jobs() -> List[Dict[str, Any]]:
    ...
    job_data = {
        ...
        "Frontend Developer": {"min_salary": 70000, "max_salary": 160000, "level": "mid"},
        "Backend Developer": {"min_salary": 85000, "max_salary": 190000, "level": "mid"},
        "Full Stack Developer": {"min_salary": 75000, "max_salary": 170000, "level": "mid"},
        ...
        "Engineering Manager": {"min_salary": 140000, "max_salary": 280000, "level": "senior"},
        "Junior Developer": {"min_salary": 50000, "max_salary": 80000, "level": "junior"},
        "Python Developer": {"min_salary": 80000, "max_salary": 170000, "level": "mid"},
        "JavaScript Developer": {"min_salary": 75000, "max_salary": 160000, "level": "mid"},
        "React Developer": {"min_salary": 70000, "max_salary": 150000, "level": "mid"},
        "Node.js Developer": {"min_salary": 80000, "max_salary": 165000, "level": "mid"},
        "Cloud Architect": {"min_salary": 130000, "max_salary": 260000, "level": "senior"},
        "Cybersecurity Engineer": {"min_salary": 100000, "max_salary": 200000, "level": "senior"},
        ...
        "Site Reliability Engineer": {"min_salary": 110000, "max_salary": 220000, "level": "senior"},
    }
    
    companies = [
        "Google", "Meta", "Amazon", "Microsoft", "Apple", "Netflix", "Uber", "Airbnb",
        "Stripe", "Snowflake", "Databricks", "OpenAI", "Anthropic", "Discord", "Figma",
        "Notion", "Slack", "Zoom", "Shopify", "Square", "PayPal", "Adobe", "Salesforce",
        "Twitter", "LinkedIn", "GitHub", "GitLab", "Atlassian", "Spotify", "Reddit"
    ]
    ...
    skills_by_role = {
        ...
        "Backend Developer": ["Python", "Java", "Node.js", "SQL", "Docker", "Kubernetes"],
        "Data Scientist": ["Python", "R", "SQL", "Machine Learning", "Statistics", "Pandas"],
        "DevOps Engineer": ["AWS", "Docker", "Kubernetes", "Terraform", "Jenkins", "Python"],
        "Machine Learning Engineer": ["Python", "TensorFlow", "PyTorch", "MLOps", "SQL", "AWS"],
    }
    ...
    for i in range(100):
        ...
        required_skills = random.sample(base_skills, min(len(base_skills), random.randint(3, 6)))
        
        # Generate job description
        description = f"We are looking for a talented {job_title} to join our {company} team. " \
        ...
        job = {
            ...
            "location_string": f"{location['city']}, {location['state']}" if location['state'] else location['city'],
            "salary": {
                "amount": salary,
                "currency": "USD",
                "period": "yearly",
            ...
            "benefits": random.sample([
                "Health Insurance", "Dental Insurance", "401k", "Stock Options",
                "Flexible Hours", "Remote Work", "Paid Time Off", "Professional Development"
            ], random.randint(3, 6)),
            "job_source": random.choice(["LinkedIn", "Indeed", "AngelList", "Stack Overflow", "Company Website"]),
    ...
    for job in jobs:
        try:
            ...
            if posted_date_str:
                ...
                days_since_posted = (current_time.replace(tzinfo=posted_date.tzinfo) - posted_date).days
            else:
                days_since_posted = 0
            ...
            hot_skills = ["AI", "Machine Learning", "React", "Python", "AWS", "Kubernetes", "TypeScript", "Go", "Rust"]
            hot_skills_count = len([skill for skill in required_skills if skill in hot_skills])
            ...
            if any(word in title_lower for word in ['ai', 'machine learning', 'ml', 'data scientist']):
                job_category = 'ai_ml'
            ...
            demand_keywords = ['urgent', 'immediate', 'asap', 'multiple positions', 'hiring now']
...
def save_data(data: List[Dict[str, Any]], analysis: Dict[str, Any], output_dir: str) -> Dict[str, str]:
    """
...
def main():
    ...
    try:
        ...
        high_salary_jobs = len([j for j in processed_jobs if j.get('salary_level') in ['high', 'very_high']])
        remote_jobs = len([j for j in processed_jobs if j.get('remote_option', False)])
        
        logger.info(f"Tech Jobs ETL completed successfully!")
