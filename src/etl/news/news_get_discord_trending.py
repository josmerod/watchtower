...
def generate_mock_discord_communities() -> List[Dict[str, Any]]:
    ...
    community_data = [
        {"name": "The Coding Den", "category": "programming", "focus": "general programming", "size_range": "large"},
        {"name": "Python Discord", "category": "programming", "focus": "python development", "size_range": "very_large"},
        {"name": "JavaScript Mastery", "category": "programming", "focus": "javascript development", "size_range": "large"},
        {"name": "React Developers", "category": "frameworks", "focus": "react development", "size_range": "large"},
        {"name": "Vue.js Community", "category": "frameworks", "focus": "vue development", "size_range": "medium"},
        {"name": "Angular Community", "category": "frameworks", "focus": "angular development", "size_range": "medium"},
        {"name": "Rust Programming", "category": "programming", "focus": "rust development", "size_range": "medium"},
        {"name": "Go Developers", "category": "programming", "focus": "golang development", "size_range": "medium"},
        {"name": "AI/ML Engineers", "category": "ai_ml", "focus": "artificial intelligence", "size_range": "large"},
        {"name": "Data Science Hub", "category": "ai_ml", "focus": "data science", "size_range": "large"},
        {"name": "DevOps Community", "category": "devops", "focus": "devops practices", "size_range": "large"},
        {"name": "Cloud Architects", "category": "cloud", "focus": "cloud computing", "size_range": "medium"},
        {"name": "Cybersecurity Pros", "category": "security", "focus": "cybersecurity", "size_range": "large"},
        {"name": "Web3 Developers", "category": "blockchain", "focus": "blockchain development", "size_range": "medium"},
        {"name": "Game Developers", "category": "gamedev", "focus": "game development", "size_range": "large"},
        {"name": "Mobile App Devs", "category": "mobile", "focus": "mobile development", "size_range": "medium"},
        {"name": "Open Source Contributors", "category": "opensource", "focus": "open source projects", "size_range": "large"},
        {"name": "Tech Startups", "category": "startup", "focus": "startup discussions", "size_range": "medium"},
        {"name": "Freelance Developers", "category": "freelance", "focus": "freelance work", "size_range": "medium"},
        {"name": "UI/UX Designers", "category": "design", "focus": "user interface design", "size_range": "large"},
        {"name": "Backend Engineers", "category": "programming", "focus": "backend development", "size_range": "large"},
        {"name": "Frontend Masters", "category": "programming", "focus": "frontend development", "size_range": "large"},
        {"name": "Database Admins", "category": "database", "focus": "database management", "size_range": "small"},
        {"name": "System Administrators", "category": "sysadmin", "focus": "system administration", "size_range": "medium"},
        {"name": "Tech Career Advice", "category": "career", "focus": "career development", "size_range": "large"},
    ]
    ...
    for i, community_info in enumerate(community_data):
        ...
        daily_growth = random.randint(5, 200) if community_info["size_range"] in ["large", "very_large"] else random.randint(1, 50)
        weekly_growth = daily_growth * random.randint(5, 7)
        
        # Generate activity metrics
        online_members = random.randint(int(member_count * 0.02), int(member_count * 0.15))
        messages_per_day = random.randint(100, 5000) if community_info["size_range"] in ["large", "very_large"] else random.randint(20, 1000)
        
        # Server features
        features = random.sample([
            "voice_channels", "stage_channels", "community_features", "threads", 
            "announcements", "moderation_tools", "welcome_screen", "rules_channel",
            "events", "server_discovery", "verified", "partnered"
        ], random.randint(4, 8))
        ...
        descriptions = {
            ...
            "devops": f"DevOps professionals sharing experiences, tools, and practices for better software delivery and infrastructure management.",
            "security": f"Cybersecurity community focused on threat analysis, security tools, ethical hacking, and industry best practices.",
            "blockchain": f"Web3 and blockchain development community exploring DeFi, smart contracts, and decentralized applications.",
            "gamedev": f"Game developers of all levels sharing experiences, showcasing projects, and collaborating on game development.",
            "design": f"UI/UX designers sharing design trends, critiques, resources, and career advice in the design industry."
        }
        
        description = descriptions.get(community_info["category"], f"A thriving community focused on {community_info['focus']} and related technologies.")
        ...
        community = {
            ...
            "verified": random.choice([True, False]) if community_info["size_range"] in ["large", "very_large"] else False,
            "partnered": random.choice([True, False]) if community_info["size_range"] == "very_large" else False,
            "has_discovery": random.choice([True, False]),
            "language": "English",
            "region": random.choice(["US West", "US East", "Europe", "US Central", "US South"]),
...
def process_discord_communities(communities: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    """
    ...
    for community in communities:
        try:
            ...
            engagement_rate = (online_members / member_count * 100) if member_count > 0 else 0
            activity_score = (messages_per_day / member_count * 1000) if member_count > 0 else 0
            ...
            processed_community = {
                **community,
                ...
                "is_verified_or_partnered": community.get('verified', False) or community.get('partnered', False),
                "platform": "discord",
            ...
            logger.warning(f"Error processing community {community.get('name', 'unknown')}: {e}")
            continue
    
    # Sort by trending score
    processed_communities.sort(key=lambda x: x.get('trending_score', 0), reverse=True)
    
    logger.info(f"Successfully processed {len(processed_communities)} Discord communities")
...
def main():
    ...
    try:
        ...
        trending_communities = len([c for c in processed_data if c.get('is_trending', False)])
        verified_communities = len([c for c in processed_data if c.get('is_verified_or_partnered', False)])
        
        logger.info(f"Discord Trending Communities ETL completed successfully!")
