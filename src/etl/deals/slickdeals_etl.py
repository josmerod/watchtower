...
def _determine_deal_category(text: str) -> List[str]:
    ...
    category_keywords = {
        "electronics": ["electronics", "gadget", "phone", "tablet", "camera", "headphones", "speaker", "tv", "monitor"],
        "computers": ["computer", "laptop", "desktop", "cpu", "gpu", "ram", "ssd", "hard drive", "motherboard", "pc"],
        "home_garden": ["home", "garden", "furniture", "kitchen", "appliance", "decor", "cleaning", "tools"],
        "clothing": ["clothing", "shoes", "fashion", "apparel", "shirt", "pants", "dress", "jacket", "sneakers"],
        "books_media": ["book", "ebook", "movie", "dvd", "blu-ray", "music", "game", "software", "app"],
        "health_beauty": ["health", "beauty", "cosmetics", "skincare", "supplements", "fitness", "wellness"],
        "automotive": ["car", "automotive", "tire", "oil", "parts", "accessories", "tools"],
        "toys_games": ["toy", "games", "board game", "video game", "console", "puzzle", "kids"],
        "food_grocery": ["food", "grocery", "snack", "coffee", "tea", "restaurant", "delivery"],
...
def _extract_store_mentions(text: str) -> List[str]:
    ...
    common_stores = [
        "Amazon", "Walmart", "Target", "Best Buy", "Home Depot", "Lowes", "Costco", "Sam's Club",
        "eBay", "Newegg", "B&H", "Adorama", "Staples", "Office Depot", "GameStop", "Barnes & Noble",
        "Macy's", "Nordstrom", "Nike", "Adidas", "Apple", "Microsoft", "Google", "Dell", "HP",
        "Lenovo", "ASUS", "Samsung", "Sony", "LG", "Philips", "Panasonic", "Canon", "Nikon"
    ]
...
def _calculate_deal_score(text: str) -> float:
    ...
    # High-value keywords
    high_value_keywords = ["free", "clearance", "limited time", "flash sale", "today only", "expires"]
...
def _assess_deal_urgency(text: str) -> str:
    ...
    high_urgency_keywords = ["today only", "flash sale", "ending soon", "while supplies last", "limited quantity"]
    medium_urgency_keywords = ["limited time", "sale ends", "this week only", "weekend only"]
