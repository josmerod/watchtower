...
class MusicDealsETL(BaseETL):
    ...
    def _get_curated_music_deals(self) -> list[dict[str, Any]]:
        ...
        curated = [
            ...
            {
                "title": "Deezer Free Music Streaming",
                "description": "Free music streaming with shuffle mode and curated playlists",
                ...
                "download_format": ["Stream only"],
                "drm_free": False,
                "tags": ["streaming", "playlists", "discovery", "french"],
                "created_date": datetime.now(timezone.utc).isoformat(),
                "fetched_at": datetime.now(timezone.utc).isoformat(),
                "source": "Curated",
            },
            {
                "title": "Tidal Free Tier",
                "description": "High-fidelity audio streaming with free tier and extensive music library",
                "url": "https://tidal.com/",
                "platform": "Tidal",
                "category": "music",
                "deal_type": "free_streaming",
                ...
                "download_format": ["Stream only"],
                "drm_free": False,
                "tags": ["streaming", "hi-fi", "mqa", "artist-owned"],
                "created_date": datetime.now(timezone.utc).isoformat(),
                "fetched_at": datetime.now(timezone.utc).isoformat(),
                "source": "Curated",
            },
            {
                ...
                "description": "3-month free trial of premium music streaming with spatial audio",
                "url": "https://www.apple.com/apple-music/",
                "platform": "Apple Music",
                "category": "music",
                "deal_type": "free_trial",
                "original_price": 120,  # Annual cost
                "current_price": 0,
                "savings": 120,
                "discount_percentage": 100,
                "music_type": "streaming",
                ...
                "download_format": ["Stream only"],
                "drm_free": False,
                "tags": ["streaming", "spatial audio", "apple ecosystem", "free trial"],
                "created_date": datetime.now(timezone.utc).isoformat(),
                "fetched_at": datetime.now(timezone.utc).isoformat(),
                "source": "Curated",
            },
            {
                "title": "Qobuz High-Resolution Streaming",
                "description": "High-resolution audio streaming service with extensive classical catalog",
                "url": "https://www.qobuz.com/",
                "platform": "Qobuz",
                "category": "music",
                "deal_type": "premium_streaming",
                "original_price": 180,  # Annual cost
                "current_price": 180,
                "savings": 0,
                "discount_percentage": 0,
                "music_type": "streaming",
                ...
                "download_format": ["Stream only"],
                "drm_free": False,
                "tags": ["hi-res", "classical", "audiophile", "french"],
                "created_date": datetime.now(timezone.utc).isoformat(),
                "fetched_at": datetime.now(timezone.utc).isoformat(),
                "source": "Curated",
            },
            {
                "title": "Audiomack Free Music",
                "description": "Free music discovery platform focused on hip-hop and emerging artists",
                ...
                "download_format": ["Stream only"],
                "drm_free": True,
                "tags": ["free", "hip-hop", "emerging artists", "discovery"],
                "created_date": datetime.now(timezone.utc).isoformat(),
                "fetched_at": datetime.now(timezone.utc).isoformat(),
                "source": "Curated",
            },
            {
                "title": "Mixcloud Free Streaming",
                "description": "Radio shows, DJ mixes, and podcasts with free streaming",
                ...
                "download_format": ["Stream only"],
                "drm_free": False,
                "tags": ["radio", "dj mixes", "podcasts", "electronic"],
                "created_date": datetime.now(timezone.utc).isoformat(),
                "fetched_at": datetime.now(timezone.utc).isoformat(),
                "source": "Curated",
            },
            {
                "title": "TuneIn Radio Free",
                "description": "Free radio streaming with 100,000+ stations worldwide",
                "url": "https://tunein.com/",
                "platform": "TuneIn",
                "category": "music",
                "deal_type": "free_streaming",
                "original_price": 120,  # Premium cost
                "current_price": 0,
                "savings": 120,
                "discount_percentage": 100,
                "music_type": "radio",
                ...
                "download_format": ["Stream only"],
                "drm_free": False,
                "tags": ["radio", "live", "global", "talk radio"],
                "created_date": datetime.now(timezone.utc).isoformat(),
                "fetched_at": datetime.now(timezone.utc).isoformat(),
                "source": "Curated",
            },
            {
                "title": "Last.fm Free Music Discovery",
                "description": "Music discovery and recommendation service with free tier",
                "url": "https://www.last.fm/",
                "platform": "Last.fm",
                "category": "music",
                "deal_type": "free_discovery",
                "original_price": 36,  # Pro cost
                "current_price": 0,
                "savings": 36,
                "discount_percentage": 100,
                "music_type": "discovery",
                "genre": "all",
                "artist_type": "all",
                "download_format": ["Recommendations"],
                "drm_free": False,
                "tags": ["discovery", "recommendations", "scrobbling", "community"],
                "created_date": datetime.now(timezone.utc).isoformat(),
                "fetched_at": datetime.now(timezone.utc).isoformat(),
                "source": "Curated",
            },
