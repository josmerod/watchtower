...
from src.models.ai_platforms import AIModelRelease, PlatformUpdate, APIUsageMetrics
...
class OpenAIPlatformETL(BaseETL):
    ...
    def _assess_announcement_impact(self, post: Dict[str, Any]) -> str:
        ...
        high_impact_keywords = ['gpt-5', 'new model', 'pricing', 'api changes', 'breaking']
    ...
    def _determine_follow_up_actions(self, record: Dict[str, Any]) -> List[str]:
        ...
        if impact_level == 'high':
            return ['detailed_analysis', 'stakeholder_notification', 'competitive_response']
    ...
    def load(self, data: List[Dict[str, Any]]) -> None:
        ...
        try:
            ...
            self.logger.info(f"Loaded OpenAI data to {output_file}")
            ...
            self.logger.error(f"Failed to load OpenAI data: {e}")
            raise
