...
class CinemaECarteleraImprovedETL(BaseETL[dict, CinemaMovie]):
    ...
    def extract_movie_data_enhanced(self, movie_elem, cinema_info: dict, date: str) -> dict:
        ...
        try:
            ...
            title_selectors = [
                'h3', 'h2', 'h4', 'h1',
                '.title', '[class*="title"]', '[class*="titulo"]',
                '.movie-title', '.film-title',
                'a[href*="pelicula"]', 'a[href*="movie"]',
                'strong', 'b'
            ]
            ...
            try:
                ...
                # Extract genre
                genre_keywords = [
                    'acción', 'drama', 'comedia', 'thriller', 'romance',
                    'ciencia ficción', 'terror', 'aventura', 'musical',
                    'animación', 'documental', 'familiar'
                ]
                ...
                for line in lines:
                    ...
                    if ('director' in line_lower or 'dirigida' in line_lower) and not movie_data.get('director'):
                        ...
                        for prefix in ['Director:', 'Dir:', 'Dirigida por:', 'Directed by:']:
                    ...
                    if ('reparto' in line_lower or 'actores' in line_lower or 'protagonistas' in line_lower) and not movie_data.get('cast'):
                        ...
                        for prefix in ['Reparto:', 'Actores:', 'Protagonistas:', 'Cast:']:
