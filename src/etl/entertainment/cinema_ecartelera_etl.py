...
class CinemaECarteleraETL(BaseETL[dict, CinemaMovie]):
    ...
    def extract_movie_data(self, movie_elem, cinema_info: dict, date: str, page) -> dict:
        ...
        try:
            # Extract title
            title_selectors = ['h3', 'h2', 'h4', '.title', '[class*="title"]', '[class*="titulo"]']
            ...
            info_selectors = ['.info', '.datos', '[class*="info"]', '[class*="datos"]', 'p']
            for selector in info_selectors:
                try:
                    ...
                    for j in range(info_elements.count()):
                        ...
                        genre_keywords = ['acción', 'drama', 'comedia', 'thriller', 'romance', 'ciencia ficción', 'terror', 'aventura']
            ...
            # Extract cast
            cast_selectors = ['.cast', '.reparto', '[class*="cast"]', '[class*="reparto"]']
            ...
            # Extract showtimes
            showtimes = []
            time_selectors = ['.horarios', '.sesiones', '.times', '[class*="hora"]', '[class*="sesion"]']
            ...
            rating_selectors = ['.rating', '.puntuacion', '[class*="rating"]', '[class*="nota"]']
