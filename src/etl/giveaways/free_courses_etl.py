...
class FreeCoursesETL(BaseETL):
            ...
            for item in items[:20]:  # Get latest 20 posts
                try:
                    ...
                    if any(keyword in title_lower for keyword in [
                        'course', 'tutorial', 'learn', 'guide', 'handbook', 
                        'complete', 'bootcamp', 'masterclass', 'training'
                    ]):
    ...
    def _extract_course_tags(self, title: str, description: str) -> List[str]:
        ...
        technology_keywords = [
            ...
            'web development', 'mobile', 'android', 'ios', 'flutter', 'swift'
        ]
    ...
    def _calculate_course_relevance_score(self, course: Dict[str, Any]) -> float:
        ...
        tags = course.get('tags', [])
        high_demand_skills = ['python', 'javascript', 'react', 'machine learning', 'aws', 'data science']
        for tag in tags:
