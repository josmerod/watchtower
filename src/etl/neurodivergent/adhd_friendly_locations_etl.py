...
class ADHDFriendlyLocationsETL(BaseETL):
    ...
    def __init__(self, **kwargs):
        ...
        self.location_types = {
            ...
            'coffee_shops': {'base_score': 6, 'noise_tolerance': 3, 'fidget_friendly': 8},
            'coworking_spaces': {'base_score': 7, 'noise_tolerance': 2, 'fidget_friendly': 9},
        ...
        mock_locations = [
            {
                ...
                'amenities': ['wifi', 'quiet_zones', 'natural_light', 'comfortable_seating'],
                'noise_level': 'quiet',
                ...
                'opening_hours': {'mon_fri': '9:00-20:00', 'sat': '9:00-14:00', 'sun': 'closed'},
                'contact': {'phone': '+34 96 352 54 78', 'website': 'https://bibliotecas.valencia.es'},
            ...
            },
            {
                ...
                'amenities': ['wifi', 'outdoor_seating', 'background_music', 'laptop_friendly'],
                ...
                'contact': {'phone': '+34 96 351 73 36', 'website': 'https://cafecentral.es'},
                'extracted_at': datetime.utcnow().isoformat()
            },
            {
                'data_type': 'location',
                ...
                'contact': {'phone': '+34 96 315 68 00', 'website': 'https://jardinbotanico.org'},
                'extracted_at': datetime.utcnow().isoformat()
            }
        ]
        ...
        mock_reviews = [
            {
                ...
                'pros': ['natural_light', 'quiet_zones', 'comfortable_chairs', 'stable_wifi'],
            ...
            },
            {
                ...
                'pros': ['background_music', 'coffee_stimulation', 'people_watching', 'flexible_seating'],
                'cons': ['crowded_peak_hours', 'inconsistent_noise_levels', 'fluorescent_lighting'],
                'recommended_for': ['creative_work', 'social_meetings', 'brainstorming'],
    ...
    def _generate_location_intelligence(self) -> List[Dict[str, Any]]:
        ...
        daily_intelligence = {
            ...
            'best_locations_by_need': {
                'hyperfocus_sessions': ['Biblioteca Central', 'Jardín Botánico reading areas'],
                'creative_work': ['Café Central terrace', 'Modern art museum quiet zones'],
    ...
    def _assess_escape_routes(self, record: Dict[str, Any]) -> Dict[str, Any]:
        ...
        escape_assessment = {
            ...
            'coffee_shop': {'ease': 'easy', 'social_pressure': 'moderate', 'logistics': 'simple'},
