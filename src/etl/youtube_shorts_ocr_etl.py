...
class URLExtractor:
    ...
    def reconstruct_popular_domains(
        self,
        text: str,
        confidence: float,
        timestamp: float,
...
def extract_text_from_frame(
    ...
    best_result = {"text": "", "confidence": 0.0, "method": "none", "urls": []}
...
def extract_text_from_video_frames(
    ...
    return {"text": final_text, "urls": final_urls, "metadata": metadata}
