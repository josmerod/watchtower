...
class WatcherState:
    ...
    def __init__(self, last_check: datetime | None = None, check_count: int = 0,
                 event_count: int = 0, last_event_id: str = "", metadata: Dict[str, Any] | None = None):
...
class WatcherEvent:
    ...
    def __init__(self, event_type: str, data: Any, timestamp: datetime | None = None, event_id: str | None = None):
