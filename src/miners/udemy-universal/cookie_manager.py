...
class CookieManager:
    ...
    def get_cookies_browser_cookie3(self, browser: str = None) -> Optional[Dict[str, str]]:
    ...
    def get_cookies_sqlite(self, browser: str = None) -> Optional[Dict[str, str]]:
    ...
    def _extract_cookies_from_sqlite(self, cookie_path: str, browser: str) -> Optional[Dict[str, str]]:
    ...
    def _extract_chromium_cookies(self, cookie_path: str) -> Optional[Dict[str, str]]:
                    ...
                    for name, value in results:
                        ...
                        if isinstance(value, bytes):
                            try:
                                ...
                                # Skip encrypted cookies for now
                                continue
                        cookies[name] = value
    ...
    def _extract_firefox_cookies(self, profile_path: str) -> Optional[Dict[str, str]]:
    ...
    def get_cookies_with_fallback(self, browser: str = None) -> Optional[Dict[str, str]]:
    ...
    def load_cookies(self, filename: str = "udemy_cookies.json") -> Optional[Dict[str, str]]:
...
def get_cookies(browser: str = None) -> Optional[Dict[str, str]]:
