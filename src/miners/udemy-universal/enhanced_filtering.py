...
class EnhancedFilter:
    ...
    def _get_category_mappings(self) -> Dict[str, List[str]]:
        ...
        """
        return {
            "development": ["development", "programming", "coding", "software", "web-development", "mobile-development"],
            "business": ["business", "entrepreneurship", "marketing", "sales", "management", "finance"],
            "design": ["design", "graphic-design", "ui-ux", "web-design", "art", "photography"],
            "it-software": ["it-software", "information-technology", "networking", "cybersecurity", "database"],
            "personal-development": ["personal-development", "productivity", "leadership", "communication"],
            "music": ["music", "audio", "sound-design", "music-production"],
            "health-fitness": ["health-fitness", "wellness", "nutrition", "exercise", "yoga"],
            "lifestyle": ["lifestyle", "travel", "cooking", "hobby", "pets"],
            "teaching": ["teaching", "education", "training", "academic"],
            "office-productivity": ["office-productivity", "microsoft-office", "excel", "powerpoint", "word"],
            "marketing": ["marketing", "digital-marketing", "social-media", "advertising", "seo"],
            "photography": ["photography", "photo-editing", "videography", "visual-arts"]
        }
    ...
    def apply_rule(self, course: CourseData, rule: FilterRule) -> Tuple[bool, str]:
        ...
        try:
            ...
            return True, f"Error in {rule.name}: {str(e)}"
