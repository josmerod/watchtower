"""Command-Line Interface for Discounted Udemy Course Enroller (DUCE) - Enroller.

This script takes a list of Udemy course URLs (typically generated by
`cli.py`) and attempts to enroll in them using user-provided credentials
or browser cookies. It handles login, course checking, and enrollment processes.
"""
...
def main_enroll():
    ...
    try:
        ...
        logger.error(f"Error loading settings: {e!s}")
        logger.debug(traceback.format_exc())  # Log the full traceback at debug level
