...
try:
    ...
    from statistics_reporter import StatisticsReporter, start_session, end_session
    ...
    from logger import get_logger, setup_structured_logging, create_metrics_logger
    
    # Import original modules
    from base import VERSION, Scraper, Udemy, scraper_dict
    from cli import main_extract, create_scraping_thread
    from enroll import main_enroll, handle_login, display_results
...
Enhanced Features: {'Available' if self.enhanced_features else 'Limited'}
        ...
        extract_parser.add_argument("--sites", nargs="+", choices=list(scraper_dict.keys()),
        ...
        extract_parser.add_argument("--output", default="courses_to_enroll.json",
                                  help="Output file for extracted courses")
        
        # Enroll command
        enroll_parser = subparsers.add_parser("enroll", help="Enroll in extracted courses")
        enroll_parser.add_argument("--input", default="courses_to_enroll.json",
        ...
        run_parser.add_argument("--sites", nargs="+", choices=list(scraper_dict.keys()),
                              help="Specific sites to scrape")
        ...
        # Global options
        parser.add_argument("--config", "-c", help="Configuration file path", default="duce-cli-settings.json")
        ...
        if self.enhanced_features:
            ...
            parser.add_argument("--stats", action="store_true",
                              help="Show enrollment statistics")
            parser.add_argument("--days", type=int, default=30,
                              help="Number of days for statistics (default: 30)")
            parser.add_argument("--validate-config", metavar="FILE",
                              help="Validate configuration file and exit")
            parser.add_argument("--create-default-config", metavar="FILE",
                              help="Create default configuration file and exit")
            parser.add_argument("--test-cookies", action="store_true",
