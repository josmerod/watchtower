...
class TechnologyMetrics(BaseModel):
    ...
    github_stars: int | None = Field(default=None, ge=0, description="GitHub stars count")
    github_forks: int | None = Field(default=None, ge=0, description="GitHub forks count")
    github_issues: int | None = Field(default=None, ge=0, description="GitHub open issues")
    stackoverflow_questions: int | None = Field(default=None, ge=0, description="StackOverflow questions")
    npm_downloads: int | None = Field(default=None, ge=0, description="NPM weekly downloads")
    pypi_downloads: int | None = Field(default=None, ge=0, description="PyPI monthly downloads")
    job_postings: int | None = Field(default=None, ge=0, description="Job postings count")
    dev_mentions: int | None = Field(default=None, ge=0, description="DEV community mentions")
...
class TechnologyModel(TimestampedModel):
    ...
    official_website: str | None = Field(default=None, description="Official website URL")
    ...
    # Release information
    first_release_date: datetime | None = Field(default=None, description="First release date")
    ...
    salary_premium: float | None = Field(default=None, description="Salary premium percentage")
...
class TechnologyPredictionModel(BaseModel):
    ...
    def expected_growth_percentage(self) -> float:
        ...
        if self.current_score > 0:
            return round(
                ((self.predicted_score - self.current_score) / self.current_score) * 100,
                1,
            )
        return 0.0
...
class FrameworkBattleModel(BaseModel):
    ...
    rising_star: str | None = Field(default=None, description="Fastest growing framework")
