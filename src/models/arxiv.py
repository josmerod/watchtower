...
class GitHubRepositoryModel(TimestampedModel):
    ...
    html_url: Optional[HttpUrl] = Field(default=None, description="GitHub repository URL")
    description: Optional[str] = Field(default=None, description="Repository description")
    stars: Optional[int] = Field(default=None, ge=0, description="Number of stars")
    forks: Optional[int] = Field(default=None, ge=0, description="Number of forks")
    watchers: Optional[int] = Field(default=None, ge=0, description="Number of watchers")
    open_issues: Optional[int] = Field(default=None, ge=0, description="Number of open issues")
    last_updated: Optional[datetime] = Field(default=None, description="Last update timestamp")
    created_at: Optional[datetime] = Field(default=None, description="Repository creation timestamp")
    language: Optional[str] = Field(default=None, description="Primary language")
    languages: Optional[Dict[str, int]] = Field(default=None, description="Language breakdown")
    topics: List[str] = Field(default=[], description="Repository topics")
    has_issues: Optional[bool] = Field(default=None, description="Has issues enabled")
    has_projects: Optional[bool] = Field(default=None, description="Has projects enabled")
    has_wiki: Optional[bool] = Field(default=None, description="Has wiki enabled")
    has_pages: Optional[bool] = Field(default=None, description="Has GitHub Pages enabled")
...
class PapersWithCodeModel(TimestampedModel):
    ...
    pwc_id: Optional[str] = Field(default=None, description="Papers With Code ID")
    pwc_url: Optional[HttpUrl] = Field(default=None, description="Papers With Code URL")
    pwc_title: Optional[str] = Field(default=None, description="Papers With Code title")
    proceeding: Optional[str] = Field(default=None, description="Conference or journal")
...
class ArxivPaperModel(TimestampedModel):
    ...
    pdf_url: Optional[HttpUrl] = Field(default=None, description="PDF download URL")
    comment: Optional[str] = Field(default=None, description="Author comments")
    
    # Processing metadata
    processed_date: datetime = Field(
        default_factory=datetime.utcnow,
        description="When this paper was processed"
    )
...
class EnhancedArxivPaperModel(ArxivPaperModel):
    ...
    cluster_id: Optional[int] = Field(default=None, description="Cluster assignment ID")
    cluster_label: Optional[str] = Field(default=None, description="Human-readable cluster label")
    ...
    technology_readiness_level: Optional[TechnologyReadinessLevel] = Field(
        default=None,
        description="Technology readiness level assessment"
    )
    ...
    innovation_score: float = Field(
        ...
        ge=0.0,
        le=10.0,
        description="Innovation potential score (0-10)"
    )
    ...
    github_info: Optional[GitHubRepositoryModel] = Field(default=None, description="GitHub repository information")
    papers_with_code_info: Optional[PapersWithCodeModel] = Field(default=None, description="Papers With Code information")
    ...
    citation_potential: float = Field(
        ...
        ge=0.0,
        le=10.0,
        description="Predicted citation potential (0-10)"
    )
    ...
    quality_indicators: Dict[str, float] = Field(
        default={},
        description="Various quality indicators and their scores"
    )
    trends_alignment: Dict[str, float] = Field(
        default={},
        description="Alignment with current technology trends"
    )
    ...
    def is_breakthrough(self) -> bool:
        ...
        return (
            self.industry_impact_score >= 8.0 or
            self.innovation_score >= 8.0 or
            self.overall_significance_score >= 7.5
        )
            ...
            "examples": [
                {
                    ...
                    "related_technologies": ["AutoML", "Neural Networks", "Deep Learning"],
                    "potential_applications": ["Enterprise ML", "Automated Model Design"],
