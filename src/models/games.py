...
class AllKeyShopGameModel(TimestampedModel):
    ...
    image_url: Optional[HttpUrl] = Field(
        default=None, description="Game cover image URL"
    )
    ...
    store_name: Optional[str] = Field(
        default=None, description="Store offering the deal"
    )
    ...
    metacritic_score: Optional[int] = Field(
        default=None, description="Metacritic score"
    )

    # Release information
    release_date: Optional[datetime] = Field(
        default=None, description="Game release date"
    )
