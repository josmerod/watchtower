...
class TrendBadge(BaseModel):
    ...
    color: str = Field(default="danger", description="Bootstrap color class (e.g., 'danger', 'success')")
...
class TrendAnalysis(BaseModel):
    ...
    indicators: Dict[str, TrendIndicator] = Field(default_factory=dict, description="Specific indicators (e.g., 'views', 'mentions')")
    badge: Optional[TrendBadge] = None
