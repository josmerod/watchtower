...
NEWS_SOURCES_CONFIG = {
    "futuretools": {
        "path": os.path.join(
            project_root, "data", "futuretools", "futuretoolsnews.json"
        ),
        "name": "FutureTools",
    },
    "bensbites": {
        "path": os.path.join(project_root, "data", "bensbites", "bensbites_news.json"),
        "name": "Ben's Bites",
    },
    "hackernews": {
        "path": os.path.join(project_root, "data", "hackernews", "hackernews.json"),
        "name": "Hacker News",
    },
    "medium_genai": {
        "path": os.path.join(project_root, "data", "medium_genai", "medium_genai.json"),
        "name": "Medium GenAI",
    },
    "kdnuggets": {
        "path": os.path.join(project_root, "data", "kdnuggets", "kdnuggets.json"),
        "name": "KDnuggets",
    },
    "gooddevs": {
        "path": os.path.join(project_root, "data", "gooddevs", "gooddevs_latest.json"),
        "name": "Good Devs",
    },
    "meneame_general": {
        "path": os.path.join(
            project_root, "data", "meneame", "meneame_general_latest.json"
        ),
        "name": "Meneame General",
    },
    "meneame_tecnologia": {
        "path": os.path.join(
            project_root, "data", "meneame", "meneame_tecnologia_latest.json"
        ),
        "name": "Meneame Tech",
    },
    "podcasts": {
        "path": os.path.join(project_root, "data", "podcasts", "podcasts_latest.json"),
        "name": "Podcasts",
    },
}
