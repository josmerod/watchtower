    ...
    return html.Div(
        [
            ...
            html.Div(
                ...
                children=render_shortcuts_tab_layout(ALL_SHORTCUTS_DATA),
            ),
        ]
    )
...
def get_all_shortcuts():
    ...
    predefined_path = os.path.join(
        project_root, "data", "shortcuts", "predefined_shortcuts.json"
    )
    custom_path = os.path.join(
        project_root, "data", "shortcuts", "custom_shortcuts.json"
    )
