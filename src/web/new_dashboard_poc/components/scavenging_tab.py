    ...
    try:
        ...
        table = dash_table.DataTable(
            ...
            style_cell_conditional=[
                {
                    'if': {'column_id': 'Título'},
                    'minWidth': '200px', 'width': '200px', 'maxWidth': '300px',
                },
                {
                    'if': {'column_id': 'Enlace'},
        ...
        return html.Div([
            ...
            html.P(f"Mostrando {len(df_display)} elementos", className="text-muted mb-3"),
            table,
    ...
    try:
        ...
        if not categories_map:
            return html.Div([
                dbc.Alert(
                    [
                        html.H4("No Scavenging Data Available", className="alert-heading"),
        ...
        for category in sorted(categories_map.keys()):
            ...
            category_content.append(
                dcc.Tab(
                    ...
                    children=[
                        html.Div([
                            create_category_table(category, df)
                        ], className="p-3")
                    ]
                )
            )
        ...
        return html.Div([
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    html.P(f"Displaying RSS entries across {len(categories_map)} categories", className="text-muted")
                ])
            ], className="mb-4"),
        ...
        ], className="p-4", id="scavenging-tab-content")
