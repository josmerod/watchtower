...
from src.web.dashboard.components.news_tab import get_all_news_data, format_article_date
    ...
    def search(self, query: str, limit: int = 50) -> list[dict]:
        ...
        try:
            ...
            if not df.empty:
                ...
                mask = df["display_title"].str.lower().str.contains(search_lower, na=False) | \
                       df["display_summary"].str.lower().str.contains(search_lower, na=False)
