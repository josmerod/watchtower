...
class ETLHealthMetrics(BaseModel):
    ...
    last_run_time: Optional[datetime] = Field(None, description="Last successful run time")
    success_rate: Optional[float] = Field(None, description="Recent success rate percentage")
...
class MetricsSummary(BaseModel):
    ...
    last_etl_run_times: Dict[str, Optional[datetime]] = Field(..., description="Last run times per ETL")
