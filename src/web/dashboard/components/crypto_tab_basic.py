...
def create_crypto_cards(data):
    ...
    cards = [
        ...
        dbc.Card(
            dbc.CardBody([
                html.H4(f"{dominant_sentiment[0].title()}", className="card-title text-info"),
    ...
    return dbc.Container([
        ...
        dbc.Row([
            dbc.Col([
                ...
                html.P("Real-time cryptocurrency sentiment analysis and market intelligence", 
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    dbc.CardHeader([
                        html.H5("Recent Crypto Sentiment Data", className="mb-0"),
                        html.Small(f"Showing latest {min(50, len(crypto_data))} entries", className="text-muted")
                    ]),
                    dbc.CardBody([
