...
def process_crypto_data(data):
    ...
    for item in data:
        ...
        processed_item = {
            "timestamp": item.get(
                "timestamp",
                item.get("date", item.get("created_at", datetime.now().isoformat())),
            ),
...
def create_advanced_metrics_cards(data):
    ...
    # week_ago reserved for future metrics

    recent_hour = df[df["datetime"] >= hour_ago]
    recent_day = df[df["datetime"] >= day_ago]
    # recent_week reserved for future use
                            ...
                            dbc.Row(
                                [
                                    dbc.Col(
                                        [
                                            dbc.Badge(
                                                f"📊 {len(processed_data)} Total Records",
                                                color="primary",
                                                className="me-2",
                                            ),
                                            dbc.Badge(
                                ...
                                [
                                    dbc.CardHeader(
                                        [
                                            ...
                                            html.Small(
                                                "Real-time sentiment timeline, confidence metrics, and engagement analysis",
                                                className="text-muted",
                                            ),
                                        ]
                                    ),
                                ...
                                [
                                    dbc.CardHeader(
                                        [
                                            ...
                                            html.Small(
                                                "Mention volume, sentiment distribution, and market perception analysis",
                                                className="text-muted",
                                            ),
                                        ]
                                    ),
                                ...
                                [
                                    dbc.CardHeader(
                                        [
                                            ...
                                            html.Small(
                                                f"Detailed view of {min(100, len(processed_data))} most recent entries with advanced filtering",
                                                className="text-muted",
                                            ),
                                        ]
                                    ),
