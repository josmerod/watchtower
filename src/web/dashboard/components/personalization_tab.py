...
from src.models.user_profile_model import ResearchDomain, SkillLevel
                                        ...
                                        [
                                            ...
                                            dbc.CardBody(
                                                [
                                                    ...
                                                    # Status message
                                                    html.Div(
                                                        id="personalization-save-status",
                                                        className="mt-2",
                                                    ),
                                                ]
                                            ),
                                ...
                                [
                                    dbc.Card(
                                        [
                                            ...
                                            dbc.CardBody([html.Div(id="personalization-progress")]),
                                        ]
                                    )
                                ]
                            )
...
def register_personalization_callbacks(app):
    ...
    def save_profile(n_clicks, user_id, skill_level, domains):
        ...
        try:
            ...
            return dbc.Alert(f"Error: {e!s}", color="danger", duration=3000)
    ...
    def get_recommendations(n_clicks, user_id):
        ...
        try:
            ...
            if not profile:
                return dbc.Alert("No profile found. Please save your profile first.", color="warning")
            ...
            papers_file = project_root / "data" / "ai_research" / "ai_research_latest.json"
            ...
            recommendations = recommendation_engine.recommend_papers(profile, papers, top_n=10)
            ...
            return dbc.Alert(f"Error: {e!s}", color="danger")
