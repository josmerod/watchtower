...
def create_giveaways_tab():
    ...
    return html.Div([
            ...
            html.Div([
                ...
                dcc.Dropdown(
                    ...
                    options=[
                        ...
                        {"label": "📚 Books & Courses", "value": "education"},
        ...
        html.Div([
            html.Div([
                dcc.Graph(id="giveaways-category-chart")
            ], className="col-md-6"),
            html.Div([
                dcc.Graph(id="giveaways-platform-chart")
            ], className="col-md-6")
        ], className="row mb-4"),
...
def update_giveaways_content(category_filter, platform_filter, availability_filter, sort_filter, n_intervals):
    ...
    return summary_cards, platform_options, category_chart, platform_chart, giveaways_list
...
def load_all_giveaways_data() -> List[Dict[str, Any]]:
    ...
    # Load free games
    try:
        games_path = get_data_path("giveaways", "free_games.json")
    ...
    # Load free courses
    try:
        courses_path = get_data_path("giveaways", "free_courses.json")
...
def filter_giveaways_data(data: List[Dict], category_filter: str, platform_filter: str, availability_filter: str) -> List[Dict]:
...
def create_summary_cards(all_data: List[Dict], filtered_data: List[Dict]) -> html.Div:
    ...
    return html.Div([
        ...
        html.Div([
            html.Div([
                html.H4(f"${total_savings:,.0f}", className="card-title text-warning"),
