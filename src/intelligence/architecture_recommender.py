...
from src.models.architecture_pattern_model import ArchitecturePattern, ArchitecturalStyle, TeamSize, ComplexityLevel
...
class ArchitectureRecommender:
    ...
    def _load_patterns(self) -> List[ArchitecturePattern]:
        ...
        try:
            ...
            pattern_file = root / "data" / "architecture_patterns" / "patterns.json"
    ...
    def get_pattern_by_id(self, pattern_id: str) -> Optional[ArchitecturePattern]:
    ...
    def recommend_patterns(
        ...
        top_n: int = 5
    ) -> List[Tuple[ArchitecturePattern, float, Dict[str, float]]]:
    ...
    def _score_skill_complexity(self, user_profile: UserProfile, pattern: ArchitecturePattern) -> float:
        ...
        if skill == "beginner":
            if complexity == "low": return 1.0
            if complexity == "medium": return 0.6
            return 0.2
            
        if skill == "intermediate":
            if complexity == "medium": return 1.0
            if complexity == "low": return 0.9
            if complexity == "high": return 0.6
            return 0.3
            
        if skill == "advanced":
            if complexity == "high": return 1.0
            if complexity == "medium": return 0.9
            if complexity == "very high": return 0.8
            return 0.7
