...
new_shortcuts = {
    "Development Tools": [
        ...
        },
        {
            ...
            "icon": "🦸",
            "description": "JSON viewer and explorer"
        }
    ],
    ...
    "AI & Machine Learning": [
        {
            ...
            "icon": "🧠",
            "description": "Curated ArXiv papers"
        },
        {
            "name": "FutureTools",
        ...
        },
        {
            ...
            "icon": "🤗",
            "description": "Host and demo ML apps"
        }
    ],
    ...
    "Productivity": [
        ...
        },
        {
            ...
            "icon": "🛠️",
            "description": "Free PDF, video, image tools"
        }
    ],
    "Valencia Tech": [
        {
            ...
            "icon": "🚀",
            "description": "Local startup ecosystem"
        },
        {
            "name": "VLCTechHub Slack",
            "url": "https://vlctechhub.org/slack/",
            "icon": "💬",
            "description": "Local tech community chat"
        }
    ]
}
