...
def deploy():
    ...
    try:
        ...
        commands = [
            ...
            f"docker run -d --name {DOCKER_IMAGE} --restart unless-stopped -p {HOST_PORT}:{CONTAINER_PORT} -v /mnt/user/appdata/watchtower/data:/app/data -v /mnt/user/appdata/watchtower/logs:/app/logs -e TZ=Europe/Madrid -e BROWSERLESS_ENDPOINT=ws://REDACTED_LAN_IP:3000 {DOCKER_IMAGE}",
