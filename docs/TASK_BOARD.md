...
| T-097 | todo | P2 | Triage de vulnerabilidades Dependabot (66 en main tras el push) | sec | GitHub reporta 66 alerts (3 critical, 35 high, 22 moderate, 6 low) + una riada de PRs dependabot abiertos por el push 2026-09-10. Triage: `gh api repos/josmerod/watchtower/dependabot/alerts` + revisar PRs; priorizar las 3 critical (¿runtime o dev-dep?), mergeear por grupos (dependabot agrupa pip minor/patch), documentar los descartados. Las alertas eran latentes — el repo no recibía push desde agosto. |
